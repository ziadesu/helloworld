...
line = LINE()
#line = LINE("Ep2sgM9lsmn19ygn1ITc.BCbae36SwzYKrVGprBVzpa.o+NJbb2K/kB53KJEr4e7+5RP2sU6lv3waa8Ttb3h+3U=")
#line = LINE("topkek433@gmail.com","Yeti2904")
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    line.sendContact(to, "u6dc040137eac599ca446f80f45bbd93c")
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "Speed Testing...")
